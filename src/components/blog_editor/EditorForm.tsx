...
import { UPLOAD_PRESET, CLOUDINARY_URL } from "../../service/Cloudinary";
        ...
        >
          ...
          <Stack spacing={3}>
            <TextField
              ...
              onChange={(e) =>
                setFormData((prev: any) => ({ ...prev, featuredImage: e.target.value }))
              }
            ...
            >
              ...
              <Button
                type="submit"
                variant="contained"
                disabled={updateBlogMutation.isPending || !isFormValid}
                startIcon={updateBlogMutation.isPending ? <Save /> : <Update />}
                sx={{
                  borderRadius: 1,
                  flex: 2,
                  py: 1.5,
