          ...
          <Grid container spacing={6} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={4}>
                <Box>
                  <Chip
                    label="The Biggest Blogging Platform"
                    sx={{
                  ...
                  >
                    Create beautiful blogs with our modern, intuitive platform.
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                  <Button
                    ...
                    onClick={() =>
                      navigate(isAuthenticated ? "/blogs/new" : "/signup")
                    }
                    sx={{
                      bgcolor: "white",
                      color: "primary.main",
                ...
                >
                  <Box
                    sx={{
                      ...
                      borderRadius: 0.5,
                      mb: 2,
                      background: "url('/blog.jpeg') center",
                    }}
                  />
